	...
	switch (enumPortName)
		...
		case PORT_A:
			if (enumPinNum < PIN_13)
			{
				if (enumPinNum < PIN_8)
				{
					GPIOA->AFRL |= (u8AltFun << (enumPinNum * 4));
				}
				else
				{
					GPIOA->AFRH |= (u8AltFun << ((enumPinNum - 8) * 4));
				}
			}
			else
			{
		...
		case PORT_B:
			if (enumPinNum < PIN_2 || enumPinNum > PIN_4)
			{
				if (enumPinNum < PIN_8)
				{
					GPIOB->AFRL |= (u8AltFun << (enumPinNum * 4));
				}
				else
				{
					GPIOB->AFRH |= (u8AltFun << ((enumPinNum - 8)* 4));
				}
			}
			else
			{
		...
		case PORT_C:
			if (enumPinNum < PIN_8)
			{
				GPIOC->AFRL |= (u8AltFun << (enumPinNum * 4));
			}
			else
			{
				GPIOC->AFRH |= (u8AltFun << ((enumPinNum - 8) * 4));
			}
			break;
		}
}
